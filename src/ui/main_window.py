    ...
    def load_settings(self):
        if os.path.exists(SETTINGS_FILE):
            try:
                ...
                self.combo_ocr.setCurrentText(s.get("ocr_engine", "RapidOCR"))
                self.combo_translator.setCurrentText(s.get("translator_engine", "Hybrid (Auto)"))
                self.combo_source.setCurrentText(s.get("source_lang", "English"))
                self.combo_target.setCurrentText(s.get("target_lang", "Indonesian"))
